...
<head>
    ...
    <meta name="keywords" content="สุขภาพดี,คู่มือการออกกำลังกายอย่างถูกต้อง,วิธีดูแลสุขภาพ,โปรแกรมคำนวณดัชนีมวลกาย(BMI)">
    <link rel="shortcut icon" type="image/x-icon" href="img/icon.png"/>
    <link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">คู่มือการออกกำลังกายอย่างถูกต้อง
      <!-- Custom Fonts -->
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <center><div class="dropdown ">
            ...
            <div class="dropdown-menu">
              <a  href="#" style="font-size: 15px; width: 5px;"> BMI <i class="fa fa-line-chart" aria-hidden="true"></i></a>
              <a  href="#" style="font-size: 15px; width: 5px;"> BMR <i class="fa fa-line-chart" aria-hidden="true"></i></a>
            </div>
          </div>
          </div>
        </div>
